...
from utils.image_processing import process_image, create_grid
...
async def startup_event():
    ...
    generator = ArtGenerator(device=device)
    await generator.load_models()
    
    # Initialize Universe Navigator
    print("🗺️  Building Universe Map...")
    universe_navigator = UniverseNavigator(generator)
...
async def health_check():
    return {
        ...
        "universe_ready": universe_navigator is not None
    }
